package vip.yoxiang.netty.chapter08;// Generated by the protocol buffer compiler.  DO NOT EDIT!
...
public final class SubscribeRespProto {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SUBRESID_FIELD_NUMBER = 1;
    private int subResId_;
    /**
     * <code>int32 subResId = 1;</code>
     */
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + SUBRESID_FIELD_NUMBER;
      hash = (53 * hash) + getSubResId();
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(SubscribeResp other) {
        ...
        if (other.getSubResId() != 0) {
          setSubResId(other.getSubResId());
        }
       ...
       * <code>int32 subResId = 1;</code>
       */
      public Builder setSubResId(int value) {
  ...
  static {
    String[] descriptorData = {
      ...
      "\n\010subResId\030\001 \001(\005\022\020\n\010respCode\030\002 \001(\005\022\014\n\004de" +
      "sc\030\003 \001(\tB\024B\022SubscribeRespProtob\006proto3"
    };
    ...
    internal_static_SubscribeResp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SubscribeResp_descriptor,
        new String[] { "SubResId", "RespCode", "Desc", });
  }
